...
<div class="grid-wrapper">
 ...
 <a href="/countrypages/Benin/">Benín</a>
 </div>
 ...
 <a href="/countrypages/Bosnia%20and%20Herzegovina/">Bosnia y Herzegovina</a>
 </div>
 ...
 <a href="/countrypages/Cambodia/">Camboya</a>
 </div>
 ...
 <a href="/countrypages/Pakistan/">Pakistán</a>
 </div>
 ...
 <a href="/countrypages/Turkmenistan/">Turkmenistán</a>
 </div>
 ...
 <a href="/countrypages/Uzbekistan/">Uzbekistán</a>
 </div>
...
<figcaption class="image-caption">Nuestros avances en distintos países. Haga clic para ampliar.</figcaption>
</div> 
...
<div class="progress-section"> 
   <button id="refresh-btn" style="margin-bottom:1rem;">
     🔄 Actualizar estadísticas (sólo haz clic si las barras no están "cargando...")
   </button>


  <div class="progress-item">
    <label>Contribuyentes mapeando con <code>#MapYourGrid</code> hashtag:</label>
  ...
  <div class="progress-item">
    <label>Estimación total de torres añadidos por mapeadores de las organizaciones MapYourGrid:</label>
    <div class="progress">
      <div class="progress-bar" id="tower-bar" style="background-color: #17a2b8;"></div>
    </div>
    <span id="tower-count">Loading…</span>
    <br>
    <span id="tower-updated" style="font-size:0.8em; color:#666">Última actualización: —</span>
  </div>

  <div class="progress-item">
    <label>Estimación total de la longitud de líneas electricas añadidas por mapeadores de las organizaciones MapYourGrid:</label>
    <div class="progress">
  ...
  <div class="progress-item">
    <label>Estimación total de la capacidad añadida por mapeadores de las organizaciones MapYourGrid:</label>
    <div class="progress">
  ...
  <div class="progress-item">
    <label>Total de las subestaciones añadidas por mapeadores de las organizaciones MapYourGrid:</label>
    <div class="progress">
      <div class="progress-bar" id="substation-bar" style="background-color: #17a2b8;"></div>
    </div>
    <span id="substation-count">Loading…</span>
    <br>
    <span id="substation-updated" style="font-size:0.8em; color:#666">Última actualización: —</span>
  </div>

  <div class="progress-item">
    <label>Estimación total de torres añadidos por la comunidad <code>#MapYourGrid</code>:</label>
    <div class="progress">
    ...
    <br>
    <span id="community-tower-updated" style="font-size:0.8em; color:#666">Última actualización: —</span>
  </div>

  <div class="progress-item">
    <label>Estimación total de lineas añadidas por la comunidad MapYourGrid <code>#MapYourGrid</code>:</label>
    <div class="progress">
...
¿Quieres calcular tu propio progreso? Echa un vistazo a este [interfaz web](https://open-energy-transition.github.io/KPI-OSM/) donde puedes calcular el número de torres/postes que has colocado en un país, las subestaciones editadas y la capacidad total de MW que has añadido a un país.
<script>
